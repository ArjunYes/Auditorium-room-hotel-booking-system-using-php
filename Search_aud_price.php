    ...
    *{
    ...
    <body>
    	<div class="container">
            <center><h1 class= "new_heading">SEARCH BY PRICE LIMITS</h1></center>

    	<form action="Search_aud_price.php" method="POST">
            <center>
    	<input class="in1" type="number" name="min_rate" placeholder="MIN RATE">
        <input class="in1" type="number" name="max_rate" placeholder="MAX RATE">
    ...
    echo "</tr>";
        ...
        $sql ="select * from auditorium_details where Aud_rate between $min_rate and $max_rate";
