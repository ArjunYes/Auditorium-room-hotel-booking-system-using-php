...
<body>
	...
	<div class="container1"><br><br><br><br><br>
		<center><h1 class="heading">ADMINISTRATOR LOGIN</h1></center>
		...
		<form action="" method="POST" >
					...
					<input class="in1" type="text" name="Staff_id" placeholder="ADMIN ID " required=""><br>
					<input class="in1" type="password" name="password1" placeholder="ADMIN PASSWORD" required=""><br>
			...
			<?php
				...
				if(isset($_POST['btn'])){
					...
					if ($_POST['Staff_id']=='150285' and $_POST['password1']=='abhijithddmca'){
